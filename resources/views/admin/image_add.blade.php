...
<div class="col-lg-6">
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="{{route('admin_image_store',['content_id'=>$data->id])}}" method="post" class="" enctype="multipart/form-data">
                @csrf
                    ...
                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                        ...
                        @foreach($images as $rs)
                            <tr>
                                ...
                                <td><a href="{{route('admin_image_delete',['id'=>$rs->id,'content_id'=>$data->id])}}"onclick="return confirm('Are you sure you want to delete this item?')"><img src="{{asset('assets/admin/assets/images')}}/delete.png" height="25"></a> </td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
